...
The new implementation will be built against the strict-isolation clean-room workspace at [`docs/video/lagarith/`](https://github.com/OxideAV/docs/tree/master/video/lagarith). The Implementer in this repo reads only `spec/` and `tables/` (plus `reference/docs/` if the workspace exposes a public format spec).
